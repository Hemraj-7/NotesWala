        ...
        <div className='w-full md:min-h-[500px] border border-black p-2 rounded-lg'>
          <h2 className='text-xl font-bold text-center p-3'>Assignments</h2>
            <ul className='flex flex-col gap-2 p-3 px-5'>
              ...
              <li className='text-slate-500 hover:text-black'><Link href={'/assignment/Probability Statistics Assignment Set 1.pdf'}>Probability & Statistics Assignment Set 1</Link></li>
        ...
        <div className='w-full md:min-h-[500px] border border-black p-2 rounded-lg'>
          <h2 className='text-xl font-bold text-center p-3'>Notifications</h2>
            <ul className='flex flex-col gap-2 p-3 px-5'>
              ...
              <li className='text-slate-500 hover:text-black'><Link href={'/notify/Previous Year Questions Paper.pdf'}>Previous Year Quetions Paper</Link></li>
